# terraform-datadog-monitor/host/memory

Configures monitor for Host Memory Utilization.
...
| <a name="input_memory_use_message"></a> [memory\_use\_message](#input\_memory\_use\_message) | Flag to enable Free memory alerting | `string` | `"true"` | no |
