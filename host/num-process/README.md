# terraform-datadog-monitor/host/num-process

Number of Processes Check to alert on stale or runaway processes.
...
| Name | Type |
|------|------|
| [datadog_monitor.num_process_check](https://registry.terraform.io/providers/datadog/datadog/latest/docs/resources/monitor) | resource |
