# terraform-datadog-monitor/aws/ecs-fargate
...
| <a name="input_fargate_check_enabled"></a> [fargate\_check\_enabled](#input\_fargate\_check\_enabled) | Enable Fargate check monitor | `bool` | `true` | no |
...
| <a name="input_fargate_check_use_message"></a> [fargate\_check\_use\_message](#input\_fargate\_check\_use\_message) | Whether to use the query alert base message for Fargate check monitor | `bool` | `false` | no |
