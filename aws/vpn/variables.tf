...
# VPN tunnel state
########################################
variable "tunnel_state_enabled" {
  default     = false
  description = "Enable VPN tunnel state monitor"
  type        = bool
}

variable "tunnel_state_evaluation_window" {
  default     = "last_5m"
  description = "Evaluation window for monitor (`last_?m` (1, 5, 10, 15, or 30), `last_?h` (1, 2, or 4), or `last_1d`]"
  type        = string
}

variable "tunnel_state_no_data_window" {
  default     = 10
